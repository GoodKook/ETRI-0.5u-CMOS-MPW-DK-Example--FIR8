...
VL_INLINE_OPT void Vfir_pe___024root___ico_sequent__TOP__0(Vfir_pe___024root* vlSelf) {
    ...
    VL_ASSIGN_ISI(8,vlSelf->__Vcellinp__fir_pe__Xin, vlSelf->Xin);
    VL_ASSIGN_ISI(16,vlSelf->__Vcellinp__fir_pe__Yin, vlSelf->Yin);
}
...
VL_INLINE_OPT void Vfir_pe___024root___nba_sequent__TOP__0(Vfir_pe___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vcellout__fir_pe__Xout = vlSelf->__Vcellinp__fir_pe__Xin;
    vlSelf->__Vcellout__fir_pe__Yout = vlSelf->fir_pe__DOT__y;
    VL_ASSIGN_SII(8,vlSelf->Xout, vlSelf->__Vcellout__fir_pe__Xout);
    VL_ASSIGN_SII(16,vlSelf->Yout, vlSelf->__Vcellout__fir_pe__Yout);
    vlSelf->fir_pe__DOT__y = (0xffffU & (((IData)(vlSelf->__Vcellinp__fir_pe__Xin) 
                                          * (IData)(vlSelf->__Vcellinp__fir_pe__Cin)) 
                                         + (IData)(vlSelf->__Vcellinp__fir_pe__Yin)));
}
...
#endif
            VL_FATAL_MT("../source/fir_pe.v", 11, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../source/fir_pe.v", 11, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../source/fir_pe.v", 11, "", "Active region did not converge.");
            }
