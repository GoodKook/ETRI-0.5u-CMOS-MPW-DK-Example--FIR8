...
#endif
            VL_FATAL_MT("../source/fir_pe.v", 11, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vfir_pe___024root___ctor_var_reset(Vfir_pe___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vcellout__fir_pe__Yout = VL_RAND_RESET_I(16);
    vlSelf->__Vcellinp__fir_pe__Yin = VL_RAND_RESET_I(16);
    vlSelf->__Vcellout__fir_pe__Xout = VL_RAND_RESET_I(8);
    vlSelf->__Vcellinp__fir_pe__Xin = VL_RAND_RESET_I(8);
