...
(* top =  1  *)
(* src = "../../fir_pe_wrapper.v:5.1-66.10" *)
module fir_pe_wrapper(Data_In, Data_Out, Addr, load_emu, get_emu, clk_emu, clk_dut, clk_LED);
  ...
  wire _005_;
  (* force_downto = 32'd1 *)
  (* src = "../../fir_pe_wrapper.v:52.20-52.31|/usr/local/bin/../share/yosys/xilinx/arith_map.v:116.23-116.25" *)
  (* unused_bits = "0 1 2 3" *)
  wire [3:0] _006_;
  (* force_downto = 32'd1 *)
  (* src = "../../fir_pe_wrapper.v:52.20-52.31|/usr/local/bin/../share/yosys/xilinx/arith_map.v:112.23-112.24" *)
  wire [3:0] _007_;
  (* force_downto = 32'd1 *)
  (* src = "../../fir_pe_wrapper.v:52.20-52.31|/usr/local/bin/../share/yosys/xilinx/arith_map.v:112.26-112.27" *)
  wire [3:0] _008_;
  wire _009_;
  wire _010_;
  (* force_downto = 32'd1 *)
  ...
  input clk_emu;
  wire clk_emu;
  (* src = "../../fir_pe_wrapper.v:49.15-49.22" *)
  wire [3:0] counter;
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "../../fir_pe_wrapper.v:52.20-52.31|/usr/local/bin/../share/yosys/xilinx/arith_map.v:176.11-184.5" *)
  CARRY4 _034_ (
    .CI(1'h0),
    .CO(_006_),
    .CYINIT(1'h0),
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "../../fir_pe_wrapper.v:26.5-46.8|/usr/local/bin/../share/yosys/xilinx/ff_map.v:68.41-68.95" *)
  FDRE #(
    .INIT(1'hx)
  ) _101_ (
    .C(_016_),
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "../../fir_pe_wrapper.v:50.5-53.8|/usr/local/bin/../share/yosys/xilinx/ff_map.v:68.41-68.95" *)
  FDRE #(
    .INIT(1'hx)
  ) _125_ (
    .C(\u_fir_pe.clk ),
  ...
  assign _017_[2:0] = { \vectOut[2] [7], \vectOut[1] [7], \vectOut[0] [7] };
  assign _018_[3:2] = _017_[4:3];
  assign _007_[3:1] = counter[3:1];
  assign _013_[1:0] = _017_[4:3];
